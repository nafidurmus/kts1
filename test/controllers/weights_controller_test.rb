...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { date: @weight.date, gender: @weight.gender, ideal_weight: @weight.ideal_weight, lenght: @weight.lenght, weight: @weight.weight } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { date: @weight.date, gender: @weight.gender, ideal_weight: @weight.ideal_weight, lenght: @weight.lenght, weight: @weight.weight } }
